...
class Showcase_Widget extends WP_Widget {
	...
	public function form( $instance ) {
        ...
        <p>
            ...
            <textarea class="widefat" id="<?php echo $this->get_field_id('text'); ?>" name="<?php echo $this->get_field_name('text'); ?>" type="text" value="<?php echo esc_attr($text); ?>" cols="30" rows="10"></textarea>
